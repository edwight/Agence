		...
		<div class="row">
				...
				<div class="col-md-5 col-sm-12 col-xs-12">
						<div class="product-image"> 
							@foreach($plato->imgs as $img)
							<img src="{{ asset($img->url) }}" class="img-responsive"> 
							@endforeach
							<span class="tag2 hot">
								HOT
							</span> 
				...
				<div class="product-deatil">
						<h5 class="name">
							...
							<a href="#">
								<span>{{$plato->categoria->name}}</span>
							</a>                            
				...
				<div class="description">
					<p>{{ str_limit($plato->descripcion,$limit = 100) }}</p>
				</div>
				<div class="product-info smart-form">
					<div class="row">
						<div class="col-md-12"> 
							<a href="{{asset('cart/'.$plato->id)}}" class="btn btn-danger">Add to cart</a>
                            <a href="{{asset('/show/'.$plato->id)}}" class="btn btn-info">More info</a>
						</div>
						<div class="col-md-12">
